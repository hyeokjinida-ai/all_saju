# 직녀 그림채 프롬프트 — 얼굴 클로즈업 (폰에서 3초 판정용)
...
COMPOSITION: Head-and-shoulders CLOSE-UP portrait. The face fills much of the frame, turned slightly toward the viewer.
...
```
STYLE: High-detail semi-realistic Korean webtoon illustration, polished rendering with rich texture,
