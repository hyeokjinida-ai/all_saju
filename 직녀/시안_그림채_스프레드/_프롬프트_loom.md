...
## A-sumuk — 순수 수묵담채(LOCK 원안)

```
STYLE: Traditional Korean ink-wash painting (sumuk damchae) on hanji paper.
...
SUBJECT: A Korean woman who is 32 years old — young and fresh-faced but composed and dignified.
...
FINISH — apply this WITHIN the chosen style above; it must NOT override the style:
...
COMPOSITION: HALF-BODY shot: she is seated at a wooden Korean loom (beteul) with a HALF-WOVEN CLOTH stretched on it.
...
Palette strictly limited to ink-black, deep indigo, and moon-pale ivory,
...
## B-hybrid — 하이브리드(담채 배경 + 고밀도 인물) ← 추천

```
STYLE: Korean webtoon illustration. The BACKGROUND is loose ink-wash (sumuk) texture on hanji paper,
...
## C-semireal — 고채도 세미리얼 웹툰(시장 1위 마감)

```
STYLE: High-detail Korean webtoon ILLUSTRATION — clearly hand-drawn, not a photograph.
...
## D-photo — 실사풍(산군 세계관 통일축)

```
STYLE: Photorealistic cinematic portrait photography. 85mm lens, shallow depth of field, natural skin texture,
...
## E-miindo — 전통 미인도·공필 세밀화

```
STYLE: Traditional Korean court beauty painting (miindo) in the manner of Shin Yun-bok,
...
## F-cel — 셀채색 웹툰(청월당축 · 비교군)

```
STYLE: Clean cel-shaded Korean romance-webtoon illustration. Crisp line art, flat color with soft gradient
...
## H-glossy — 매끈 광택 페인팅(매력 축) ← 신규

```
STYLE: Glossy, high-polish digital illustration with an immaculate, luminous finish.
...
## I-dewy — 젖은 반실사 고광택 + 배경 먹번짐 (본선) ★

```
STYLE: Ultra-polished SEMI-REALISTIC Korean illustration with a WET, DEWY finish —
