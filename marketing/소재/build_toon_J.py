...
PAN  = os.path.join(ROOT, "..", "design", "toon", "scenes_J", "panels")
PAN  = os.path.abspath(PAN)
OUTROOT = os.path.join(ROOT, "소재", "산군")
OUT = os.path.join(OUTROOT, "이미지툰_J_취준생")
...
CUTS = [
 (1, "j01.png", "서류만 스무 번 미끄러진 내가" + chr(10) + "{붙은} 썰", "(사주 한 번 본 게 다임)", True, False),
 (2, "j02.png", "이제 {메일} 열기도 무서웠음",         "또 떨어졌겠지 하고",         False, False),
 (3, "j03.png", "친구는 벌써 {붙었대}",               "언니가 사주나 보래서",       False, False),
 (4, "j04.png", "{밀어붙일 때}랑 기다릴 때가 나옴",     "지금은 기다리래",            False, False),
 (5, "j05.png", "봐주는 게 갓 쓴 {박수무당}인데",      "얼굴이 없음;;",              False, False),
 (6, "j06.png", "{그 달}에 다시 넣어보라길래",         "반신반의로 넣었음",          False, False),
 (7, "j07.png", "진짜 그 달에 {연락} 왔음",           "접어뒀던 데서",              False, False),
 (8, "j08.png", "너네도 해보라고 {링크} 가져왔음",      "아래에서 볼 수 있음",        False, True),
]
