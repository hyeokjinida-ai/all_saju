...
PAN  = os.path.join(ROOT, "..", "design", "toon", "scenes_R", "panels")
PAN  = os.path.abspath(PAN)
OUTROOT = os.path.join(ROOT, "소재", "산군")
OUT = os.path.join(OUTROOT, "이미지툰_R_레퍼런스형")
...
CUTS = [
 (1,  "r01.png", "돈 모으는 걸 포기했던 내가" + chr(10) + "{서른일곱}에 숨통 트인 썰", "(사주 딱 한 번 본 게 다임)", True,  False),
 (2,  "r02.png", "월급은 {들어오는데} 통장은 늘 그대로임", "아껴도 남는 게 없더라",       False, False),
 (3,  "r03.png", "이번 달도 {카드값} 막고 끝남 ㅋㅋ",     "이러다 평생 이러는 거 아냐?", False, False),
 (4,  "r04.png", "그러다 언니가 {사주} 얘길 꺼냄",         "돈 새는 달이 따로 있대",       False, False),
 (5,  "r05.png", "속는 셈 치고 {생년월일}만 넣어봤음",     "어차피 안 맞겠지 하고",       False, False),
 (6,  "r06.png", "근데 {돈 새는 달}이 딱 나옴",           "소름 돋아서 한참 봤음",       False, False),
 (7,  "r07.png", "봐주는 게 갓 쓴 {박수무당}인데",         "얼굴이 없음;;",               False, False),
 (8,  "r08.png", "그 달에 진짜 {목돈}이 나갔음",           "미리 안 게 어디야",           False, False),
 (9,  "r09.png", "이제 {그 달}은 아예 비워둠",             "덜 흔들림",                   False, False),
 (10, "r10.png", "너네도 해보라고 {링크} 가져왔음",         "아래에서 볼 수 있음",         False, True),
]
