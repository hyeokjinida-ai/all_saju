...
function ReviewsSection() {
  ...
  return (
    <section className="scene-wine" data-screen-label="08 Reviews" style={{
      position: 'relative', padding: '80px 24px 60px', overflow: 'hidden',
      textAlign: 'center',
    }}>
      <div style={{ position: 'relative', zIndex: 1 }}>
        <window.SectionLabel index="六" hanja="證" label="실제 후기"/>
...
function PricingSection() {
  ...
  return (
    <section className="scene-cosmos" data-screen-label="09 Pricing" style={{
      position: 'relative', padding: '80px 24px 60px', overflow: 'hidden',
      textAlign: 'center',
    }}>
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        <window.SectionLabel index="七" hanja="受" label="상담 혜택"/>
...
function FAQSection() {
  ...
  return (
    <section className="scene-wine" data-screen-label="10 FAQ" style={{
      position: 'relative', padding: '80px 24px 60px', overflow: 'hidden',
      textAlign: 'center',
    }}>
      <window.SectionLabel index="八" hanja="問" label="자주 묻는 물음"/>
...
function FinalCTASection() {
  return (
    <section className="scene-cosmos" data-screen-label="11 CTA" style={{
