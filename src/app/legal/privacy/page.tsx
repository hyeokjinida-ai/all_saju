  ...
  return (
    <div className="container py-12 max-w-3xl prose-saju">
      ...
      <ul>
        ...
        <li><strong>(선택)</strong> 휴대전화번호 — 결과지 준비 안내 및 결제 관련 연락에 이용합니다. 입력하지 않아도 결제와 서비스 이용에 제한이 없습니다.</li>
      </ul>
      <h3>4) 마케팅 정보 수신 (선택)</h3>
      <ul>
        <li>
          이용자가 결제 화면에서 <strong>별도로 동의한 경우에만</strong> 이메일·휴대전화번호를 할인 및 신규 상품
          안내에 이용합니다. 동의 여부와 동의 시각을 함께 기록합니다.
        </li>
        <li>
          동의하지 않아도 결제와 서비스 이용에 제한이 없으며, 동의 후에도 언제든 고객센터
          이메일({businessInfo.email})로 수신 거부를 요청할 수 있습니다.
        </li>
      </ul>
      <h3>5) 고객 지원</h3>
      <ul>
      ...
      <ul>
        ...
        <li>결과지 준비 안내 및 결제 관련 연락(휴대전화번호를 입력한 경우)</li>
        <li>할인·신규 상품 안내(마케팅 수신에 동의한 경우에 한함)</li>
        ...
        <table className="w-full text-sm border-collapse">
          ...
          <tbody>
            ...
            <tr className="border-b border-hairline">
              ...
              <td className="py-2 px-3">미국</td>
              <td className="py-2 px-3">수집일로부터 최대 1년 또는 위탁 계약 종료 시까지</td>
            </tr>
            <tr>
