...
export const productsSeed: ProductSeed[] = [
  ...
  // 직녀 3번째 상품 (2026-09-02 신설) — 「직녀의 재회예보」.
  //   · 라인 통일: 연애예보(만나는 달) → 결혼예보(결혼하는 해) → 재회예보(다시 잇는 달).
  //   · 계산은 인연과 같은 월운 기계(computeInyeonFacts)를 **재라벨**해 쓴다 — computeReunionFacts
  //     가 12칸을 「다시 잇는 달 / 연락해도 되는 달 / 먼저 연락하면 안 되는 달」로 다시 부른다.
  //     엔진을 포크하지 않으므로 티저가 ● 라고 한 달을 결과지가 안 짚는 사고가 안 난다.
  //   · 그림도 직녀 13컷 슬롯을 공유한다(발주 추가 최소).
  ...
  //   화면에서 검산되는 값이라 여길 바꾸면 번들 정가도 같이 바꿔야 한다.
  {
    slug: "reunion-saju",
    name: "직녀의 재회예보",
    description: "'기다리다 보면 잊힌다'는 말은 그만 — 연락해도 되는 달과 먼저 연락하면 안 되는 달을 콕 집어드려요",
    price: 29900,
  ...
  // is_addon: 홈·목록에 안 뜬다(전용 랜딩이 없다). 산군·인연·재회 결제 시트에서만 고를 수 있다.
  {
    ...
    name: "인연 대장부 — 박수무당 사주 + 연애예보 + 재회예보",
    description: "끊긴 자리부터 다시 만나는 달까지 한 번에 본다 — 박수무당 사주에 직녀의 연애예보·재회예보를 더한 묶음",
    price: 49900,
