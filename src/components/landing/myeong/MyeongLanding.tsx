  ...
  return (
    <Link
      ...
      style={{
        width: "100%",
        minHeight: 58,
        background: "linear-gradient(180deg, #ffffff 0%, #f1eaff 100%)",
        color: "var(--wine-deep)",
        border: "none",
        cursor: "pointer",
    ...
    >
      ...
      <div className="fade-up" style={{ position: "relative", zIndex: 2 }}>
        <div
          ...
          style={{ margin: "0 auto", maxWidth: 280, padding: "28px 18px 24px", background: "rgba(36,16,71,0.35)" }}
        >
          <div
  ...
  return (
    <section className="scene-cosmos" style={{ position: "relative", overflow: "hidden", textAlign: "center" }}>
      ...
      <div style={{ padding: "0 24px 70px", position: "relative", zIndex: 1, marginTop: -40 }}>
        ...
        <div style={{ background: "rgba(36,16,71,0.6)", border: "1px solid var(--gold-pale)", padding: "20px 16px", textAlign: "left" }}>
          <div
            className="mono"
    ...
    <section className="scene-cosmos" style={{ position: "relative", padding: "80px 24px 70px", overflow: "hidden", textAlign: "center" }}>
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
          <div style={{ border: "1px solid var(--gold-pale)", background: "rgba(36,16,71,0.5)", padding: "22px 14px", opacity: 0.9 }}>
          ...
          <div style={{ border: "1px solid var(--gold)", background: "rgba(150,90,255,0.06)", padding: "22px 14px" }}>
  ...
  return (
    <section className="scene-cosmos" style={{ position: "relative", padding: "80px 24px 70px", overflow: "hidden", textAlign: "center" }}>
      ...
      <div style={{ position: "relative", zIndex: 2 }}>
        ...
        <div className="gold-frame" style={{ marginTop: 40, padding: "24px 14px 22px", background: "rgba(36,16,71,0.6)" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 4 }}>
            {cols.map((c, i) => (
              <div
                ...
                style={{
                  textAlign: "center",
                  background: c.hi ? "rgba(150,90,255,0.10)" : "rgba(203,184,240,0.04)",
                  border: c.hi ? "1px solid var(--gold)" : "1px solid rgba(203,184,240,0.10)",
                  padding: "10px 4px",
                }}
              >
          ...
          <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", gap: 4 }}>
            <div
              style={{
                ...
                alignItems: "center",
                justifyContent: "center",
                background: "rgba(150,90,255,0.08)",
              }}
            >
    ...
    <section className="scene-cosmos" style={{ position: "relative", padding: "80px 24px 70px", overflow: "hidden", textAlign: "center" }}>
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
          {stats.map((s, i) => (
            <div key={i} style={{ border: "1px solid var(--gold-pale)", background: "rgba(36,16,71,0.55)", padding: "18px 10px", textAlign: "center" }}>
        ...
        <div style={{ marginTop: 24, padding: "18px 14px", border: "1px dashed var(--gold-line)", background: "rgba(36,16,71,0.4)" }}>
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12, textAlign: "left" }}>
          {chapters.map((c, i) => (
            <div
              key={i}
              style={{ display: "flex", gap: 16, alignItems: "center", border: "1px solid var(--gold-pale)", background: "rgba(36,16,71,0.5)", padding: "16px 16px" }}
            >
    ...
    <section className="scene-cosmos" style={{ position: "relative", padding: "80px 24px 60px", overflow: "hidden", textAlign: "center" }}>
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14, textAlign: "left" }}>
          {steps.map((s, i) => (
            <div key={i} style={{ padding: "20px 18px", position: "relative", overflow: "hidden", background: "rgba(36,16,71,0.6)", border: "1px solid var(--gold-pale)" }}>
              <div className="brush" style={{ position: "absolute", right: -6, bottom: -24, fontSize: 110, lineHeight: 1, color: "rgba(150,90,255,0.07)", pointerEvents: "none" }}>
                {s.hanja}
              </div>
  ...
  return (
    <section id="sample" className="scene-wine" style={{ position: "relative", padding: "80px 24px 70px", overflow: "hidden", textAlign: "center", scrollMarginTop: 20 }}>
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        >
          <div style={{ textAlign: "center", position: "relative", zIndex: 1, paddingBottom: 18, borderBottom: "1.5px solid rgba(150,90,255,0.25)" }}>
            <span className="brush" style={{ fontSize: 30, color: "#f1eaff", letterSpacing: "0.06em" }}>命 運 錄</span>
            ...
            {parts.map((p, i) => (
              <div key={i}>
                <div style={{ display: "flex", alignItems: "baseline", gap: 8, marginBottom: 5 }}>
                  <span className="mono" style={{ fontSize: 9, color: "#f1eaff", letterSpacing: "0.15em", fontWeight: 600 }}>{p.n}</span>
  ...
  return (
    <section className="scene-wine" style={{ position: "relative", padding: "80px 24px 60px", overflow: "hidden", textAlign: "center" }}>
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12, textAlign: "left" }}>
          {reviews.map((r, i) => (
            <div key={i} style={{ background: "rgba(36,16,71,0.55)", border: "1px solid var(--gold-pale)", padding: "18px 16px", position: "relative" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  <span
                    ...
                    style={{
                      ...
                      alignItems: "center",
                      justifyContent: "center",
                      background: "linear-gradient(180deg,#ffffff,#c9a8ff)",
                      color: "var(--wine-deep)",
  ...
  return (
    <section className="scene-cosmos" style={{ position: "relative", padding: "80px 24px 60px", overflow: "hidden", textAlign: "center" }}>
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        {/* 기본 풀이에 담기는 것 */}
        <div style={{ padding: "22px 20px", border: "1px solid var(--gold-pale)", background: "rgba(36,16,71,0.55)", textAlign: "left" }}>
        ...
        <div
          style={{
            ...
            background: "linear-gradient(180deg, rgba(150,90,255,0.10) 0%, rgba(36,16,71,0.65) 100%)",
            boxShadow: "0 0 24px rgba(150,90,255,0.15)",
            textAlign: "left",
          }}
        >
