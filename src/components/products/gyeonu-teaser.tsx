...
function WebtoonPanel({
   ...
   *  반복되는 효과가 아니다.
   *
   *  움직임은 **인물이 아니라 세계**가 맡는다: 강물·별빛만 흐르고 까치·산·나무는 정지다.
   *  (실측 2026-09-06: Kling 3.0 은 나는 새를 반드시 퍼덕이게 만들어 그림이 무너졌다 —
   *   하늘 연속차 15.2. **MiniMax H3** 는 같은 프롬프트로 1.6 이라 이 컷은 그쪽으로 구웠다.) */
  video,
}: {
  id: GyeonuCutId;
  alt: string;
  ...
  return (
    ...
    >
      ...
      <WebtoonPanel
        ...
        gap={104}
        /* 판에서 **유일하게 움직이는 컷**. 강물과 별빛만 흐르고 까치·산은 정지다.
