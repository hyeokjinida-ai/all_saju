...
export function StoryFooter() {
  ...
  return (
    <footer className="px-6 pb-10 pt-7 text-center" style={{ borderTop: "1px solid rgba(255,255,255,0.09)" }}>
      ...
      <p className="mx-auto mt-4 max-w-[420px] text-[11px] leading-[1.75]" style={{ color: "#7a8296" }}>
        {businessLine}
      </p>
      <p className="mt-1.5 text-[11px]" style={{ color: "#7a8296" }}>
        {contactLine}
      </p>
      <p className="mt-3 text-[11px]" style={{ color: "#7a8296" }}>
