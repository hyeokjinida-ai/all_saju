      ...
      >
        ...
        {step === 2 && (
          <div>
            ...
            {/* 산군은 반말 세계다 — 여기만 존댓말이면 화자가 바뀐 것처럼 읽힌다(2026-09-08 실측:
                산군 퍼널 전 화면 중 존댓말이 새는 자리가 여기와 아래 개인정보 안내 둘뿐이었다).
                밤 무대(직녀·재회)는 원래 해요체라 그대로 둔다. */}
            <p className="font-myeongjo mt-3 text-center text-[11px] text-bone-faint tracking-[0.06em] leading-[1.75]">
              {imm
                ? "태어난 시각을 몰라도 된다. 시(時) 기둥만 빼고 나머지 흐름은 볼 수 있다."
